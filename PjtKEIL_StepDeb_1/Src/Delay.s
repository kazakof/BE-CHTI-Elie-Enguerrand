...
BoucleTempo	
		...
		subs r1,#1  ;
		str  r1,[r0] ; VarTime--
		bne	 BoucleTempo ; Branch if not equal: on rejoue les instructions précédentes si VarTime !=0
			
		bx lr ; retourne à l'adresse de l'instruction stockée dans le registre lr
		endp
